...
public:
  Logger(Level level, const char *fname, int line) : line(line), fname(fname), level(level) {}
...
#define __LOG_WARNING ::logger::Logger(::logger::Level::WARNING, __FILE__, __LINE__)
#define __LOG_ERROR ::logger::Logger(::logger::Level::ERROR, __FILE__, __LINE__)
#define __LOG_FATAL ::logger::LoggerFatal(::logger::Level::FATAL, __FILE__, __LINE__)
